...
namespace CodeFirst1710.Controllers
{
    public class TvcSan_PhamController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("tvcId,tvcMaSanPham,tvcTenSanPham,tvcHinhAnh,tvcSoLuong,tvcDonGia,tvcLoaiSanPhamId")] TvcSan_Pham tvcSan_Pham)
        {
        ...
        private bool TvcSan_PhamExists(int id)
        {
